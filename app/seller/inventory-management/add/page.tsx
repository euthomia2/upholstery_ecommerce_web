...
import SellerInventoryAdd from "@/components/seller-dashboard/SellerInventoryAdd";
import { useGetProductsQuery } from "@/services/crud-product";

const SellerInventoryManagementAddPage = () => {
...
export default SellerInventoryManagementAddPage;
