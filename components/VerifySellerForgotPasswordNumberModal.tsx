...
import { useSellerResetPasswordMutation } from "@/services/authentication";

type VerifySellerForgotPasswordNumberModalProps = {
  sellerId: number;
  open: boolean;
...
const VerifySellerForgotPasswordNumberModal: React.FC<
  VerifySellerForgotPasswordNumberModalProps
> = ({ sellerId, open, closeModal, contact_number, title, email }) => {
...
export default VerifySellerForgotPasswordNumberModal;
