const SkeletonProductCard = () => {
  return (
    ...
    >
      ...
      <div className='h-2.5 mx-auto bg-gray-200 rounded-full dark:bg-gray-700 w-40 mb-4'></div>
      <div className='h-3 mx-auto bg-gray-200 rounded-full dark:bg-gray-700 mb-4'></div>
